...
void DIO_voidSetPortDirection(u8 Copy_u8PortId,u8 Copy_u8PinDir)
{
	   if(Copy_u8PinDir == DIO_u8OUTPUT)
	   {
	       switch(Copy_u8PortId)
	       {
	         case DIO_u8PORT_A:  DDRA=0xff; break;
	         case DIO_u8PORT_B:  DDRB=0xff; break;
	         case DIO_u8PORT_C:  DDRC=0xff; break;
             case DIO_u8PORT_D:  DDRD=0xff; break;
	   ...
	   else if(Copy_u8PinDir == DIO_u8INPUT)
	   {
		   switch(Copy_u8PortId)
		   	{
		   	   case DIO_u8PORT_A:  DDRA=0x00; break;
		   	   case DIO_u8PORT_B:  DDRB=0x00; break;
		   	   case DIO_u8PORT_C:  DDRC=0x00; break;
		       case DIO_u8PORT_D:  DDRD=0x00; break;
		       default: /*wrong port*/ break;
		   	}
	   }
	   else{/*Nothing*/}
	...
	if(Copy_u8PinVal == DIO_u8HIGH)
		   {
		       switch(Copy_u8PortId)
		       {
		         case DIO_u8PORT_A:  PORTA=0xff; break;
		         case DIO_u8PORT_B:  PORTB=0xff; break;
		         case DIO_u8PORT_C:  PORTC=0xff; break;
	             case DIO_u8PORT_D:  PORTD=0xff; break;
	             default: /*wrong port*/ break;
		       }
		   }
		   else if(Copy_u8PinVal == DIO_u8LOW)
		   {
			   switch(Copy_u8PortId)
			   	{
			   	   case DIO_u8PORT_A:  PORTA=0x00; break;
			   	   case DIO_u8PORT_B:  PORTB=0x00; break;
			   	   case DIO_u8PORT_C:  PORTC=0x00; break;
			       case DIO_u8PORT_D:  PORTD=0x00; break;
			       default: /*wrong port*/ break;
			   	}
		   }
		   else{/*Nothing*/}
